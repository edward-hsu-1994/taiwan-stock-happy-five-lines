...
function App() {
  ...
  }) as unknown as EChartsOption, [lohuoSeries])
  ...
  return <main className="page-shell">
    ...
    <p className="data-note dashboard-note">資料來源：{stock.source} · {stock.data.length.toLocaleString()} 筆日收盤價。<br />最後更新時間：{formattedLastUpdatedAt}<br />標準差五線以最近一年半歷史價格的線性趨勢與波動推導為初始基準，可拖曳調整計算期間，不代表投資建議。</p></section></div>
  </main>
}
